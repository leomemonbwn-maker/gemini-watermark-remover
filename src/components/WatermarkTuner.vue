  ...
  <div>
    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center sm:items-start justify-center">
      <div class="flex flex-col items-center w-full sm:w-auto">
        ...
        <canvas ref="mainCanvas" class="rounded-xl border border-black/10 dark:border-white/10 max-w-full bg-black/5 dark:bg-white/5"></canvas>
      </div>
