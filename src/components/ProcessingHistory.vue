...
<template>
  <section class="py-14 sm:py-20 reveal-on-scroll">
    <div class="max-w-4xl mx-auto px-4 sm:px-6">
      ...
      <!-- Empty state -->
      <div v-if="!hasEntries" class="neu-card rounded-2xl p-8 sm:p-12 text-center">
      ...
      <div v-else>
        <div class="flex items-center justify-between mb-4">
          ...
          <button
            @click="clearAll"
            class="text-xs font-bold text-red-400 hover:text-red-300 transition-colors flex items-center gap-1 py-1 px-2 min-h-[36px]"
          >
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
          <div
            ...
            :key="entry.id"
            class="neu-card rounded-xl overflow-hidden group relative"
          >
            <!-- Thumbnail -->
            <div class="aspect-square bg-neu-inset flex items-center justify-center overflow-hidden">
              <img
                :src="entry.thumbnail"
                :alt="entry.name"
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity duration-200 flex flex-col justify-end p-2.5">
              ...
              <button
                ...
                class="absolute top-2 right-2 w-7 h-7 rounded-full bg-red-500/80 hover:bg-red-500 text-white flex items-center justify-center transition-colors min-w-[28px] min-h-[28px]"
